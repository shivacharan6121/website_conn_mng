...
<head>
    ...
    <style>
        ...
        .modal-document {
            border: 4px solid black; /* Thicker for clear visibility */
    padding: 30px;
    background-color: white;
    box-sizing: border-box;
    width: 100%;
...
<body>
    ...
    <div class="container">
        <h2>LIST OF ISSUED CONNECTORS: EO-SAAW/RCI</h2><br>

        <!-- Search Bar and Record Count -->
        <div class="search-container">
            <div class="search-bar">
                <form action="issue_edit.php" method="GET">
    ...
    <script>
        function showPrintDocument(name, designation, partno, quantity, date, time) {
            ...
            const documentHTML = `
                    ...
                    <div class="document-line">
                        ...
                        <div class="document-value">${partno}</div>
                    </div>
                    <div class="document-line">
